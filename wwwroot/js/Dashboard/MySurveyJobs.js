/**
 * MySurveyJobs.js - Gozetim Islerim
 * Kabul edilen ve tamamlanan gozetim/ekspertiz isleri
 */

(function () {
    'use strict';

    function MySurveyJobsViewModel() {
        var self = this;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var container = document.getElementById('my-survey-jobs-app');
        if (container) {
            ko.applyBindings(new MySurveyJobsViewModel(), container);
        }
    });
})();
