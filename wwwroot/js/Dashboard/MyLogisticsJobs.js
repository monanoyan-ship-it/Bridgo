/**
 * MyLogisticsJobs.js - Lojistik Islerim
 * Kabul edilen ve tamamlanan lojistik isleri
 */

(function () {
    'use strict';

    function MyLogisticsJobsViewModel() {
        var self = this;
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var container = document.getElementById('my-logistics-jobs-app');
        if (container) {
            ko.applyBindings(new MyLogisticsJobsViewModel(), container);
        }
    });
})();
