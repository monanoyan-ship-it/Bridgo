        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguageCulture = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    UniqueSeoCode = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    FlagImageFileName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradeRegistryNo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    MersisNo = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Website = table.Column<string>(type: "text", nullable: true),
                    LogoUrl = table.Column<string>(type: "text", nullable: true),
                    AuthorizedPersonName = table.Column<string>(type: "text", nullable: true),
                    AuthorizedPersonTitle = table.Column<string>(type: "text", nullable: true),
                    AuthorizedPersonPhone = table.Column<string>(type: "text", nullable: true),
                    AuthorizedPersonEmail = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorRole = table.Column<int>(type: "integer", nullable: false),
