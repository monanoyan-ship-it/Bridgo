    ...
    private static async Task SeedModulesAsync(ApplicationDbContext context)
    {
        ...
        var modules = new List<PlatformModule>
        {
            ...
            new()
            {
                ...
                Route = "/Dashboard/SupplierProfile",
                DisplayOrder = 10,
                IsMenuItem = true,
                IsActive = true,
                IsMenuSection = false
            ...
            new()
            {
                ...
                Icon = "bi-truck",
                Route = "/Dashboard/LogisticsRequests",
                DisplayOrder = 11,
                IsMenuItem = true,
                IsActive = true,
                IsMenuSection = false
            ...
            new()
            {
                ...
                Icon = "bi-flag",
                Route = "/Dashboard/CustomsRequests",
                DisplayOrder = 12,
                IsMenuItem = true,
                IsActive = true,
                IsMenuSection = false
            ...
            new()
            {
                ...
                Route = "/Dashboard/InsuranceRequests",
                DisplayOrder = 13,
                IsMenuItem = true,
                IsActive = true,
                IsMenuSection = false
            ...
            new()
            {
                ...
                Route = "/Dashboard/SurveyRequests",
                DisplayOrder = 14,
                IsMenuItem = true,
                IsActive = true,
                IsMenuSection = false
